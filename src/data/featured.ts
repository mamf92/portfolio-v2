export const about = {
  heading: 'Hi, I’m Martin Fischer',
  description:
    'I’m a frontend developer based in Norway but open to explore the world. I am currently working at DNB developing a company credit hub solution as a summer intern. I have studied at Noroff and worked hard on my own projects to transition from a background in teaching to the exciting world of development. I bring strong communication skills, a user-focused mindset, and a passion for clean, accessible code.',
};
